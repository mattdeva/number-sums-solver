...
class TestMatrix:
    ...
    def test_color_values(self, matrix_1, matrix_2):
        assert matrix_1.color_values == []
        print(len(matrix_2))
        assert sorted(matrix_2.color_values) == ['FF6FA8DC', 'FFE06666']

    def test_groups(self, matrix_1, matrix_2):
        assert len(matrix_1.groups) == 6
        assert len(matrix_2.groups) == 8

    def test_get_square(self, matrix_1):
    ...
    def test_get_square_list(self, i, axis, squares, raise_error, matrix_1):
        if raise_error:
            with pytest.raises(ValueError):
    ...
    def test_get_square_color(self, matrix_2):
    ...
    def test_get_target_value(self, i, axis, target_value, raise_error, matrix_1):
        if raise_error:
            with pytest.raises(ValueError):
